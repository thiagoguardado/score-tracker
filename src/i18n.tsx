...
const englishMessages = {
  ...
  setup: {
    ...
    tapToContinue: "Tap Say player names, then speak your next command.",
...
const portugueseMessages: Messages = {
  ...
  setup: {
    ...
    tellPlayers: "Dizer jogadores", endConversation: "Encerrar conversa", namesHint: "Diga os nomes em uma única frase", tapToContinue: "Toque em Dizer jogadores e fale o próximo comando.", conversationEnded: "Conversa encerrada",

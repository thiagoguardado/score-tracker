...
const englishMessages = {
  ...
  setup: {
    ...
    voiceDescription: "Say the names, listen to the review, then say “confirm”.",
    tellPlayers: "Say player names",
    endConversation: "End conversation",
    namesHint: "Say all names in one sentence",
    ...
    microphonePermission: "Allow microphone access and check that speech recognition is enabled.",
    permissionSpeechError: (code: string) => `iOS denied access to speech recognition. Check microphone, Speech Recognition, Siri, and Dictation permissions. Diagnostic: ${code}.`,
    ...
    audioCaptureError: "The iPhone could not start the microphone. Fully close the browser, reopen it, and try again. Diagnostic: audio-capture.",
    networkSpeechError: "The iOS speech service could not connect. Check the connection and try again. Diagnostic: network.",
    interruptedSpeechError: "Speech recognition was interrupted. Reload the page and try again. Diagnostic: aborted.",
  ...
  voice: {
    ...
    microphonePermission: "Allow microphone access and check that speech recognition is enabled.",
    microphonePermissionDiagnostic: (code: string) => `Allow microphone access and check that speech recognition is enabled. Diagnostic: ${code}.`,
...
const portugueseMessages: Messages = {
  ...
  setup: {
    newGame: "Novo jogo", whoIsPlaying: "Quem vai jogar?", registerByVoice: "Cadastre por voz", voiceDescription: "Fale os nomes, confira ouvindo e diga “confirmar”.",
    tellPlayers: "Dizer jogadores", endConversation: "Encerrar conversa", namesHint: "Diga os nomes em uma única frase", conversationEnded: "Conversa encerrada",
    ...
    microphonePermission: "Permita o uso do microfone e verifique se a Siri está ativada.",
    permissionSpeechError: (code) => `O iOS recusou o acesso ao reconhecimento de voz. Verifique as permissões do microfone, Reconhecimento de Fala, Siri e Ditado. Diagnóstico: ${code}.`, couldNotHear: "Não consegui ouvir. Você pode tentar novamente ou digitar os nomes.",
    noSpeechError: "Nenhuma fala foi detectada. Fale depois que aparecer Ouvindo e tente novamente. Diagnóstico: no-speech.",
    audioCaptureError: "O iPhone não conseguiu iniciar o microfone. Feche completamente o navegador, abra-o novamente e tente de novo. Diagnóstico: audio-capture.",
    ...
    interruptedSpeechError: "O reconhecimento de voz foi interrompido. Recarregue a página e tente novamente. Diagnóstico: aborted.",
    ...
    unknownSpeechError: (code) => `O reconhecimento de voz falhou. Nada foi alterado. Diagnóstico: ${code}.`, listening: "Ouvindo…",
  },
  game: {
  ...
  voice: {
    phase: { idle: "Pronto para ouvir", listening: "Ouvindo", parsing: "Conferindo", speakingReview: "Falando", awaitingDecision: "Aguardando confirmação", applying: "Salvando", speakingRanking: "Lendo ranking", error: "A voz precisa de atenção" },
    idleMessage: "Toque e fale os pontos ou um comando", listening: "Ouvindo…", listeningAgain: "Ouvindo novamente…", didNotHear: "Não ouvi. Pode repetir?",
    unavailable: "A voz não está disponível aqui. Use a entrada manual.", microphonePermission: "Permita o uso do microfone e verifique se a Siri está ativada.",
    microphonePermissionDiagnostic: (code) => `Permita o uso do microfone e verifique se a Siri está ativada. Diagnóstico: ${code}.`,
    ...
    scoreListSeparator: ". ", roundReady: "Pontuações prontas. Diga confirmar, repetir, corrigir ou cancelar.", review: (scoreList, omitted) => `Entendi. ${scoreList}.${omitted} Diga confirmar, repetir, corrigir ou cancelar.`,
